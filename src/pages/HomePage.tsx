        ...
        <div id="statistics" className="row g-0 py-3">
            ...
            <div className="col-auto mx-auto">
                ...
                <ul className="list-group">
                    {stats?.teach.map(teachStat => (
                        <Link to={'/users/teachers/' + teachStat.name} className="text-decoration-none">
                            <li className="list-group-item d-flex justify-content-between align-items-center">
                                <div className="langWrapper">
                                    <img src={'/images/' + teachStat.name + '.svg'} className="lang-flag"/>
                                    <span className="lang-name">{getLanguageName(teachStat.name)}</span>
                                </div>
                                <span className="badge bg-primary rounded-pill ms-5">{teachStat.amount} Users</span>
                            </li>
                        </Link>
                    ))}
                </ul>
            ...
            <div className="col-auto mx-auto">
                ...
                <ul className="list-group">
                    {stats?.learn.map(learnStat => (
                        <Link to={'/users/learners/' + learnStat.name} className="text-decoration-none">
                            <li className="list-group-item d-flex justify-content-between align-items-center">
                                <div className="langWrapper">
                                    <img src={'/images/' + learnStat.name + '.svg'} className="lang-flag"/>
                                    <span className="lang-name">{getLanguageName(learnStat.name)}</span>
                                </div>
                                <span className="badge bg-primary rounded-pill ms-5">{learnStat.amount} Users</span>
                            </li>
                        </Link>
                    ))}
                </ul>
